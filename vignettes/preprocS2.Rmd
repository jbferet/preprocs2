...
download it.
Access online is requested to download the tiling grid system during the first 
run.
...
list_files <- get_s2_raster(bbox = bbox, 
                            datetime = datetime, 
...
# make sure you define a CRS corresponding to S2 product if you do not want reprojection and associated resampling

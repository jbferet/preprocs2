...
#'
#' @param path_S2_tiling_grid character. path for S2 tiling grid
#'
...
check_s2_tiling_grid <- function(path_S2_tiling_grid = NULL){
  if (is.null(path_S2_tiling_grid))
    path_S2_tiling_grid <- 'Sentinel-2_tiling_grid.kml'
  if (!file.exists(path_S2_tiling_grid)){
